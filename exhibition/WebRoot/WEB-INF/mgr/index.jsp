...
<title>Shufty Manager Home</title>
<!-- basic styles -->
				...
				<ul class="nav ace-nav">
					...
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li><a href="#"> <img src="ace/assets/avatars/avatar.png"
							...
							<li><a href="#"> <img src="ace/assets/avatars/avatar3.png"
							...
							<li><a href="#"> <img src="ace/assets/avatars/avatar4.png"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎光临,</small> ${current_user.username }
						...
						<ul
							...
							<li><a href="${basePath }mgr/logout.html"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Bob Doe's avatar"
																		src="ace/assets/avatars/user.jpg" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Joe Doe's avatar"
																		src="ace/assets/avatars/avatar2.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Jim Doe's avatar"
																		src="ace/assets/avatars/avatar.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Susan's avatar"
																		src="ace/assets/avatars/avatar3.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Phil Doe's avatar"
																		src="ace/assets/avatars/avatar4.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alexa Doe's avatar"
																		src="ace/assets/avatars/avatar1.png" />
																</div>

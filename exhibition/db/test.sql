...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112343 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'daicj', '111111', '13501234567', '13501234567@163.com', '2016-02-22 17:09:52', '1', '一直很安静', '', '');
INSERT INTO `sys_user` VALUES ('2', 'admin', '111111', '13501234560', '13501234560@163.com', '2016-02-22 17:11:05', '1', ' 十口心思，思君思国思社稷', '', '');
